...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_6" style="margin-left: 0;">
        ...
        <div class="grid grid_6" style="margin-right: 0; text-align: right">
...
<!--end section-->
<!--start section-->
<section class="nicdark_section inicio-activities">
        ...
        <div class="grid grid_8">
            ...
            <div class="grid grid_4" style="margin-left: 0;">
                <div class="nicdark_archive1 nicdark_bg_grey nicdark_radius nicdark_shadow center" style="padding: 20px 0;">
                    ...
                    <div class="nicdark_space20"></div>
                    <p>18 workshops corresponding to</p>
