    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">DARTBOT MAKING AT RONNASKOLAN</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">CREATE SIMPLE ROBOT WHICH CAN THROW DARTS</h3>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
		...
		<div class="grid grid_8">
            ...
            <h3 class="subtitle greydark">WORKSHOP SUMMARY</h3>
            <div class="nicdark_space20"></div>
            ...
            <p style="text-align: center" class="green">
                ...
                <a href="#" class="nicdark_press nicdark_btn nicdark_bg_greendark white nicdark_radius nicdark_shadow medium" onclick="javascript:unregister();"><i class="icon-ok"></i>Completed</a>
            </p>
            <div class="nicdark_space40"></div>
        ...
        <div class="grid grid_4">
            ...
            <div class="nicdark_archive1 nicdark_bg_greydark nicdark_radius nicdark_shadow">
                <div class="nicdark_margin20 nicdark_relative">
                        ...
                        <div class="nicdark_activity nicdark_marginleft100 nicdark_disable_marginleft_ipadpotr">
                            <h4 class="white">GET YOUR FEEDBACK</h4>                        
                            <div class="nicdark_space20"></div>
