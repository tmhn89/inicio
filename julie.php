    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <h3 class="subtitle white">PROFESSOR OF LIGHT @ KTH</h3>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="grid grid_4">
            <h3 class="subtitle greydark">EVENTS ATTENDING</h3>
            <div class="nicdark_space20"></div>
            <div class="nicdark_divider left small"><span class="nicdark_bg_blue nicdark_radius"></span></div>
            <div class="nicdark_space20"></div>
    ...
    <div class="nicdark_filter blue">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                <div class="nicdark_space40"></div>
                <div class="nicdark_space50"></div>
                <h2 class="white subtitle center">Julie knows it all and her lessons are so much fun.</h2>
                <div class="nicdark_space20"></div>
                <div class="nicdark_divider big center"><span class="nicdark_bg_white nicdark_radius"></span></div>
                <div class="nicdark_space20"></div>
                <h1 class="signature white center">Barack Napoleon - Arandomskolan</h1>
                <div class="nicdark_space40"></div>
                <div class="nicdark_space50"></div>
            </div>
