    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">OUR MENTOR NETWORK</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">FROM UNIVERSITIES, HIGHSCHOOL, AND THE INDUSTRY</h3>
            ...
            <div class="nicdark_archive1 nicdark_bg_orange nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="julie">JULIETTE LIGHT</a></h4>                        
                        <div class="nicdark_space20"></div>
                        ...
                        <div class="nicdark_space20"></div>
                        <a href="julie" class="white nicdark_btn"><i class="icon-graduation-cap-1"></i> Know Me :)</a>
            ...
            <div class="nicdark_archive1 nicdark_bg_blue nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="julie">JENNY MGRAYAN</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
            ...
            <div class="nicdark_archive1 nicdark_bg_yellow nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="julie">MARGARET GREY</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
            ...
            <div class="nicdark_archive1 nicdark_bg_violet nicdark_radius nicdark_shadow">
                ...
                <div class="nicdark_textevidence nicdark_width_percentage50 nicdark_width100_responsive">
                    <div class="nicdark_margin20">
                        ...
                        <h4 class="white"><a class="white" href="julie">NICK HOPE</a></h4>                        
                        <div class="nicdark_space20"></div>
                        <div class="nicdark_divider left small"><span class="nicdark_bg_white nicdark_radius"></span></div>
                        <div class="nicdark_space20"></div>
                        <p class="white">Lorem ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet, ipsum dolor sit amet.</p>
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_3">
                <div class="nicdark_textevidence center">
                    ...
                    <div class="nicdark_space20"></div>
                    <h4 class="white">Mentors</h4>
                </div>
            </div>
            <div class="grid grid_3">
                <div class="nicdark_textevidence center">
                    <a href="#" class="nicdark_width50 white nicdark_btn nicdark_bg_green nicdark_bg_greendark_hover nicdark_transition nicdark_shadow extrasize nicdark_radius_circle subtitle nicdark_counter" data-to="12" data-speed="1000">12</a>
                    <div class="nicdark_space20"></div>
            ...
            <div class="grid grid_3">
                <div class="nicdark_textevidence center">
                    <a href="#" class="nicdark_width50 white nicdark_btn nicdark_bg_yellow nicdark_bg_yellowdark_hover nicdark_transition nicdark_shadow extrasize nicdark_radius_circle subtitle nicdark_counter" data-to="18" data-speed="1000">18</a>
                    <div class="nicdark_space20"></div>
                    <h4 class="white">High Schools</h4>
                </div>
            </div>
            <div class="grid grid_3">
                <div class="nicdark_textevidence center">
                    <a href="#" class="nicdark_width50 white nicdark_btn nicdark_bg_violet nicdark_bg_violetdark_hover nicdark_transition nicdark_shadow extrasize nicdark_radius_circle subtitle nicdark_counter" data-to="15" data-speed="1000">15</a>
                    <div class="nicdark_space20"></div>
                    <h4 class="white">Companies</h4>
                </div>
            </div>
