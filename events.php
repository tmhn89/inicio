    ...
    <div class="nicdark_filter greydark">
        ...
        <div class="nicdark_container nicdark_clearfix">
            ...
            <div class="grid grid_12">
                ...
                <div class="nicdark_space100"></div>
                <h1 class="white subtitle">EVENTS</h1>
                <div class="nicdark_space10"></div>
                <h3 class="subtitle white">OTHER EVENTS AROUND THE CITY THAT MIGHT CATCH YOUR INTEREST</h3>
...
<section class="nicdark_section">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <?php include 'elements/event_line_1.html'; ?>

        <?php include 'elements/event_line_2.html'; ?>
